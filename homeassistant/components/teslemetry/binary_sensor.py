...
VEHICLE_DESCRIPTIONS: tuple[TeslemetryBinarySensorEntityDescription, ...] = (
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        polling=True,
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_PreconditioningEnabled(callback)
        ),
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        polling=True,
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_ScheduledChargingPending(callback)
        ),
        entity_category=EntityCategory.DIAGNOSTIC,
        entity_registry_enabled_default=False,
    ),
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        polling=True,
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_FrontPassengerWindow(
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_AutomaticBlindSpotCamera(callback)
        ),
        entity_registry_enabled_default=False,
    ),
    TeslemetryBinarySensorEntityDescription(
        ...
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_AutomaticEmergencyBrakingOff(
                callback
            )
        ),
        entity_registry_enabled_default=False,
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_BlindSpotCollisionWarningChime(
                callback
            )
        ),
        entity_registry_enabled_default=False,
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_BmsFullchargecomplete(callback)
        ),
        entity_registry_enabled_default=False,
    ),
    TeslemetryBinarySensorEntityDescription(
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_ChargePortColdWeatherMode(callback)
        ),
        entity_registry_enabled_default=False,
    ),
    TeslemetryBinarySensorEntityDescription(
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_EmergencyLaneDepartureAvoidance(
                callback
            )
        ),
        entity_registry_enabled_default=False,
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_SuperchargerSessionTripPlanner(
                callback
            )
        ),
        entity_registry_enabled_default=False,
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_RearDisplayHvacEnabled(callback)
        ),
        streaming_firmware="2024.44.25",
        entity_registry_enabled_default=False,
    ),
    TeslemetryBinarySensorEntityDescription(
        ...
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_OffroadLightbarPresent(callback)
        ),
        streaming_firmware="2024.44.25",
        entity_registry_enabled_default=False,
    ),
    ...
    TeslemetryBinarySensorEntityDescription(
        ...
        streaming_listener=(
            lambda vehicle, callback: vehicle.listen_DefrostForPreconditioning(callback)
        ),
        entity_registry_enabled_default=False,
        streaming_firmware="2024.44.25",
    ),
